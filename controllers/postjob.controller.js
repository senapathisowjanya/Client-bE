...
postJobRoute.post("/postjob", auth, async (req, res) => {
  ...
  try {
    ...
    payLoad.jobLink =  `https://client-j49fsf5hi-venkysanju246.vercel.app/SingleJobPost/${uniqueID}/a`;
...
postJobRoute.post("/addlink/:link", auth, async (req, res) => {
  ...
  const joblink = `https://client-j49fsf5hi-venkysanju246.vercel.app/SingleJobPost/${linkk}/a`
  // console.log(linkk)
  // console.log(joblink)
